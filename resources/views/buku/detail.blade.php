...
@section('judul')
<h1 class="text-secondary">{{ $buku->judul }}</h1>
@endsection
...
@section('content')
    <div class="card mb-4">
        ...
        @endif
        <h5 class="pengarang">Pengarang : <a href="#" class="text-warning" style="text-decoration: none">{{ $buku->pengarang }}</a></h5>
        <h5 class="penerbit">Penerbit : <a href="#" class="text-warning" style="text-decoration: none">{{ $buku->penerbit }}</a></h5>
        <h5 class="tahun_terbit">Tahun Terbit : <a href="#" class="text-warning" style="text-decoration: none">{{ $buku->tahun_terbit }}</a></h5>
